      ...
      <ul>
        ...
        <li>
            <a target="_blank" href="${pageContext.request.contextPath }/cart?action=list">
               <i class="icon_card"></i>购物车 <span>${sessionScope.cart.cartItemList.size() }</span>
            </a>
         </li>
         ...
         <c:if test="${not empty sessionScope.user }">
                 <li>
                    <a target="_blank" href="${pageContext.request.contextPath }/jsp/ordersList.jsp">
                       我的订单 <span>${sessionScope.unpaidOrdersCount }</span>
                    </a>
                </li>
                 <li><a target="_blank" href="${pageContext.request.contextPath }/address?action=list"> 收货地址 </a></li>
                 <li><a href="${pageContext.request.contextPath }/jsp/userPasswordUpdate.jsp"> 修改密码 </a></li>
